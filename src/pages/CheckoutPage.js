...
import { Box, Stack, Container, Typography, CircularProgress, Button } from '@mui/material'
                ...
                {({ elements, stripe }) => (
                  <>
                    ...
                    <Box>
                      ...
                      <form onSubmit={handleSubmit(async (data) => onSubmit(data, elements, stripe))}>
                        <Stack gap={2}>
                          ...
                          <Box width={{ xs: '100%', md: '50%' }}>
                            ...
                            <Stack gap={2}>
                              ...
                              <select defaultValue='' required {...register("shippingOptions")}>
                                <option value='' disabled hidden>  Select Shipping Option </option>
                                {
                                  shippingOptions.length === 0 ? <option value=''> Loading... </option> :
