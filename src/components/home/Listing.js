import { Box, Stack, Card, CardActionArea, CardMedia, CardContent, Typography } from '@mui/material'
  ...
  return (
    <Box pt={5} pb={5}>
      ...
      <Stack direction='row' justifyContent={{ xs: 'center', md: 'space-between' }} flexWrap='wrap' spacing={1}>
        {
          data.length === 0 ? renderLinearLoader() :
            <>
              <Box width='100%'>
                <Swiper
                  modules={[Pagination]}
                            ...
                            <CardActionArea>
                              ...
                              />
                                <CardContent>
                                  ...
                                  <Typography variant='subtitle' color='secondary'> Explore Now </Typography>
                                </CardContent>
                            </CardActionArea>
                          </Card>
                        </SwiperSlide>
