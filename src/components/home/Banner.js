  ...
  return (
    <Box style={styles.customBox}>
      <Stack direction={{ xs: 'column', md: 'row' }} justifyContent='space-between' alignItems='center' p={3}>
        ...
        <Stack direction='row' alignItems='center' spacing={1}>
          <Approval /> <Typography variant="h5" fontWeight={900}> Satisfaction Guaranteed </Typography>
        </Stack>
        <Stack direction='row' alignItems='center' spacing={1}>
          <WorkspacePremium /> <Typography variant="h5" fontWeight={900}> Quality Assurance </Typography>
        </Stack>
      </Stack>
    </Box>
  )
